...
export const translations = {
  en: {
    ...
    about: {
      ...
      smartHome: {
        ...
        subtitle: 'Complete control over all your home appliances',
        ...
        realTimeStatus: {
          ...
          running: 'Running',
          idle: 'Idle',
          currentWatts: 'Current consumption',
        },
        usageStats: {
          title: 'Usage Statistics',
          hoursToday: 'Hours active today',
          dailyEnergy: 'Daily energy consumption',
          weeklyEnergy: 'Weekly energy consumption',
          monthlyEnergy: 'Monthly energy consumption',
          monthlyShare: 'Share of monthly electricity bill',
        },
        savings: {
          title: 'Savings Indicators',
          savedAmount: 'Amount saved with this device',
          peakHours: 'Peak load hours analysis',
          pieChartTitle: 'Monthly Energy Distribution',
        },
        aiRecommendations: {
          ...
          autoPlan: 'Auto Optimization Plan (optional)',
          examples: {
            tv1: 'Today\'s energy consumption is above normal. It is recommended to have a few hours of off-time.',
            tv2: 'Vacuum and TV running simultaneously is causing line overload. Recommend turning off TV in 10 minutes.',
            tv3: 'TV\'s share in monthly energy has increased. Reducing screen brightness by 20% will save 7%.',
            vacuum1: 'Vacuum has been running at high energy for 30 minutes, increasing line overload risk.',
            vacuum2: 'It is recommended to use this device during cheaper energy periods (if available).',
          },
        },
        reports: {
          title: 'Weekly and Monthly Reports',
          dailyUsage: 'Daily energy usage',
          weeklyChart: 'Weekly pie chart',
          monthlySavings: 'Monthly savings percentage',
          topConsumers: 'Top energy consuming devices',
          energyLoss: 'Causes of energy loss',
          healthReport: 'Energy Health Report with AI analysis',
        },
      },
    },
    // Auth
  ...
  az: {
    ...
    about: {
      ...
      smartHome: {
        title: 'Smart Home İnteqrasiyası',
        subtitle: 'Evdəki bütün avadanlıqlarınız üzərində tam nəzarət',
        selectDevice: 'Avadanlığı seçin',
        devices: {
          tv: 'Televizor',
          fridge: 'Soyuducu',
          ac: 'Kondisioner',
        ...
        realTimeStatus: {
          title: 'Real vaxt göstəriciləri',
          status: 'Hazırkı vəziyyət',
          running: 'İşləyir',
          idle: 'İşləmir',
          currentWatts: 'Hazırda sərf edir',
        },
        usageStats: {
          title: 'İstifadə statistikası',
          hoursToday: 'Bu gün neçə saat işləyib',
          dailyEnergy: 'Gündəlik enerji sərfiyyatı',
          weeklyEnergy: 'Həftəlik enerji sərfiyyatı',
          monthlyEnergy: 'Aylıq enerji sərfiyyatı',
          monthlyShare: 'Aylıq elektrik pulunun neçə faizini tutur',
        },
        savings: {
          title: 'Qənaət göstəricisi',
          savedAmount: 'Bu avadanlıqla nə qədər qənaət etmisiniz',
          peakHours: 'Hansı saatlarda yük artıb (pik saatlar analizi)',
          pieChartTitle: 'Aylıq Enerji Paylanması',
        },
        aiRecommendations: {
          title: 'AI Tövsiyələr',
          riskWarnings: 'Risk xəbərdarlıqları',
          savingsTips: 'Qənaət təklifləri',
          timingAdvice: 'Vaxtlama məsləhətləri',
          autoPlan: 'Enerji optimizasiyası üçün avtomatik plan (isteğe bağlı)',
          examples: {
            tv1: 'Bu gün enerji sərfiyyəti normadan artıqdır. Tövsiyə olunur ki, bir neçə saat söndürülən vaxt intervalı olsun.',
            tv2: 'Tozsoran və televizor eyni vaxtda işlədiyi üçün xəttdə yüklənmə var. 10 dəqiqə sonra televizoru söndürmək məsləhətdir.',
            tv3: 'Aylıq enerji sərfiyyatında TV-nin payı yüksəlib. Ekran parlaqlığını 20% azaltmaq 7% qənaət gətirəcək.',
            vacuum1: 'Tozsoran son 30 dəqiqədir yüksək enerji sərfiyyəti ilə işləyir, xəttdə yüklənmə riskini artırır.',
            vacuum2: 'Bu avadanlığı günün daha ucuz enerji periodlarında (əgər varsa) işlətmək tövsiyə olunur.',
          },
        },
        reports: {
          title: 'Həftəlik və Aylıq Hesabatlar',
          dailyUsage: 'Günlük enerji istifadəsi',
          weeklyChart: 'Həftəlik pie chart',
          monthlySavings: 'Aylıq qənaət faizi',
          topConsumers: 'Ən çox enerji yeyən avadanlıqlar',
          energyLoss: 'Enerji itkisinin səbəbləri',
          healthReport: 'AI təhlili ilə Enerji Sağlamlıq Hesabatı',
        },
      },
    },
    // Auth
  ...
  ru: {
    ...
    about: {
      ...
      smartHome: {
        ...
        subtitle: 'Полный контроль над всеми домашними приборами',
        ...
        realTimeStatus: {
          title: 'Показатели в реальном времени',
          status: 'Текущий статус',
          running: 'Работает',
          idle: 'Не работает',
          currentWatts: 'Текущее потребление',
        },
        usageStats: {
          title: 'Статистика использования',
          hoursToday: 'Часов работы сегодня',
          dailyEnergy: 'Дневное потребление энергии',
          weeklyEnergy: 'Недельное потребление энергии',
          monthlyEnergy: 'Месячное потребление энергии',
          monthlyShare: 'Доля в месячном счёте за электричество',
        },
        savings: {
          title: 'Показатели экономии',
          savedAmount: 'Сколько вы сэкономили с этим устройством',
          peakHours: 'Анализ пиковых часов нагрузки',
          pieChartTitle: 'Месячное распределение энергии',
        },
        aiRecommendations: {
          title: 'Рекомендации ИИ',
          riskWarnings: 'Предупреждения о рисках',
          savingsTips: 'Советы по экономии',
          timingAdvice: 'Рекомендации по времени',
          autoPlan: 'Автоматический план оптимизации энергии (опционально)',
          examples: {
            tv1: 'Сегодня потребление энергии выше нормы. Рекомендуется выключить на несколько часов.',
            tv2: 'Пылесос и телевизор работают одновременно, создавая перегрузку линии. Рекомендуется выключить телевизор через 10 минут.',
            tv3: 'Доля телевизора в месячном потреблении выросла. Снижение яркости экрана на 20% сэкономит 7%.',
            vacuum1: 'Пылесос работает с высоким потреблением энергии уже 30 минут, увеличивая риск перегрузки.',
            vacuum2: 'Рекомендуется использовать это устройство в периоды более дешёвой энергии (если доступно).',
          },
        },
        reports: {
          title: 'Еженедельные и ежемесячные отчёты',
          dailyUsage: 'Ежедневное использование энергии',
          weeklyChart: 'Недельная круговая диаграмма',
          monthlySavings: 'Процент месячной экономии',
          topConsumers: 'Устройства с наибольшим потреблением',
          energyLoss: 'Причины потерь энергии',
          healthReport: 'Отчёт о здоровье энергопотребления с анализом ИИ',
        },
      },
    },
    // Auth
